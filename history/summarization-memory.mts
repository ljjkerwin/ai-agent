...
import { HumanMessage, SystemMessage, AIMessage, getBufferString, BaseMessage } from "@langchain/core/messages";
...
async function summarizeHistory(messages: BaseMessage[]) {
    ...
    const conversationText = getBufferString(messages, "用户");

    console.log(1111, conversationText)
