...
const OPENAI_MODEL_NAME = 'happyhorse-1.1-i2v'
...
console.log('model:', OPENAI_MODEL_NAME);
...
//   img_url: 'https://dashscope.oss-cn-beijing.aliyuncs.com/images/dog_and_girl.jpeg', // 首帧参考图，图生视频必填
  media: [
    {
        type: 'first_frame', // 首帧参考图
        url: 'https://dashscope.oss-cn-beijing.aliyuncs.com/images/dog_and_girl.jpeg', // 首帧参考图，图生视频必填
    }
  ],
  resolution: '480P', // 图生视频用 resolution（如 720P / 1080P）
